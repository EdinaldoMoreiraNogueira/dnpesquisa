package com.devnaldo.dnpesquisa.resources;
...
import com.devnaldo.dnpesquisa.services.RecordService;
...
public class RecordResource {
  ...
  private RecordService service;
    ...
    public ResponseEntity <Page<RecordDTO>> findAll (
    		@RequestParam(value = "mim", defaultValue = "") String mim,
    	...
    	Instant minDate = ("".equals(mim)) ? null : Instant.parse(mim);
